        ...
        <h1>Seller Profile</h1>
            ...
            <h2>Products:</h2>
                ...
                <div className="auctions" key={product.product_name}>
                    ...
                    <FormikAddAuction addAuction={props.addAuction} editAuction={editAuction} productId={product.id}/>
                </div>
                ))
            ) : (
            ...
            <h2>Auctions:</h2>
                ...
                <div className="auctions" key={auction.auction_name}>
                    ...
                    <button onClick={() => props.editAuction(auction.id)}>Edit Auction</button>
...
export default connect(
    mapStateToProps,
    {getSellerProducts, addProduct, getSeller, editAuction, addAuction, deleteProduct, deleteAuction}
)(SellerOverview);